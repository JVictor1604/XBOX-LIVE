...
export const EditPlataform = styled.div`
  ${({ theme }) => css`
...
export const EditPlataformImage = styled.img`
  ${() => css`
    width: 130px;
  `}
`;

export const EditPlataformDetails = styled.div`
  ${() => css`
    display: flex;
    flex-direction: column;
...
export const EditPlataformDetailsName = styled.h1`
  ${({ theme }) => css`
...
export const EditPlataformAction = styled.button`
  ${({ theme }) => css`
    width: 100%;
    display: flex;
    justify-content: center;
